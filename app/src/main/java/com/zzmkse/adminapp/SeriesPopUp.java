...
public class SeriesPopUp  extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       View view=inflater.inflate(R.layout.seriespopup,container,false);
        ...
        final CollectionReference categgoryRef=db.collection("categories");
        categgoryRef.get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
               categorynames.clear();
                for (DocumentSnapshot snapshot:queryDocumentSnapshots)
                {
                    ...
                    categorynames.add(categoryModel.categoryName);
                ...
                if (model!=null)
                {
                    ...
                    {
                        if (categorynames.get(i).equals(model.seriesCagegory))
                        {
        ...
        final EditText edt_seriesVideo=view.findViewById(R.id.edt_series_viedo_link);
        if (model!=null)
        {
            edt_seriesImage.setText(model.seriesImage);
            edt_seriesVideo.setText(model.seroesVideo);
        ...
        Button btncancle=view.findViewById(R.id.cancel_series);
